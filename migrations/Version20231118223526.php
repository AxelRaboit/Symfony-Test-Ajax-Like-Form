 ...
 */
final class Version20231118223526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "like" (id INT NOT NULL, person_id INT NOT NULL, article_id INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_AC6340B3217BBB47 ON "like" (person_id)');
        ...
        $this->addSql('ALTER TABLE "like" ADD CONSTRAINT FK_AC6340B3217BBB47 FOREIGN KEY (person_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "like" DROP CONSTRAINT FK_AC6340B3217BBB47');
